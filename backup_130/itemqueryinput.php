<html>
<body>
<form action="itemqueryaction.php" method="get">
<?php
...
Enter restaurant name: <input type="textbox" name="rest_name"><br>
Enter menu item: <input type="textbox" name="name"><br><br>
