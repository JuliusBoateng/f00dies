<html>
<body>
<form action="itemdeleteaction.php" method="get">
<?php
...
Enter the item name to delete: <input type="textbox" name="name"><br>
Enter the restaurant that this item is found at: <input type="textbox" name="rest_name"><br>
