...
/* insert */
if ($stmt = mysqli_prepare($link, "INSERT INTO ratings (user_id,item_name,rest_name,rating) VALUES (?,?,?,?)")) {
	echo "here!<br>";
	echo $_GET['user_id'] . "<br>" . $_GET['item_name'] . "<br>" . $_GET['rest_name'] . "<br>" . $_GET['rating'] . "<br>";
